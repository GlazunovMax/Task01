...
import by.epam.javatraining.glazunov.task01.model.exception.IllegalNameTrainException;
...
public class Train {
	...
	public void setNameTrain(String nameTrain) throws IllegalNameTrainException {
		if (nameTrain == null || nameTrain.isEmpty()) {
			throw new IllegalNameTrainException(MESSAGE_NAMETRAIN_EMPTY);
		}
